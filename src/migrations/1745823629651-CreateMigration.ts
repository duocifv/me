...
export class CreateMigration1745823629651 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`refresh_token\` ADD \`userId\` varchar(36) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`user_roles\` ADD PRIMARY KEY (\`role_id\`)`);
        ...
        await queryRunner.query(`ALTER TABLE \`user_roles\` ADD \`user_id\` varchar(36) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`user_roles\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`user_roles\` ADD PRIMARY KEY (\`role_id\`, \`user_id\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`refresh_token\` DROP COLUMN \`userId\``);
        await queryRunner.query(`ALTER TABLE \`refresh_token\` ADD \`userId\` int NULL DEFAULT 'NULL'`);
