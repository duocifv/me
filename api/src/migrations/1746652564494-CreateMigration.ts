...
export class CreateMigration1746652564494 implements MigrationInterface {
    name = 'CreateMigration1746652564494'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`permissions\` ADD \`id\` varchar(36) NOT NULL PRIMARY KEY`);
        ...
        await queryRunner.query(`ALTER TABLE \`roles\` CHANGE \`name\` \`name\` varchar(255) NOT NULL DEFAULT 'GUEST'`);
        ...
        await queryRunner.query(`ALTER TABLE \`role_permissions\` ADD \`permission_id\` varchar(36) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`role_permissions\` DROP PRIMARY KEY`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`role_permissions\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`role_permissions\` ADD PRIMARY KEY (\`role_id\`, \`permission_id\`)`);
        await queryRunner.query(`ALTER TABLE \`roles\` CHANGE \`name\` \`name\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`roles\` DROP COLUMN \`id\``);
