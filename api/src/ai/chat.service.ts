...
export class ChatService {
  ...
  async handleMessage(sessionId: string, message: string, chatHistory: any[]) {
    ...
    // 🔹 Nếu đầy đủ thông tin, gửi summary để user xác nhận
    ...
    if (this.isComplete(rec.booking)) {
      ...
      summaryMessage = this.buildBookingSummary(rec.booking);
      confirmRequired = true;
    }

    return { aiReply, confirmRequired, summaryMessage };
  }
